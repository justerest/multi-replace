...
function multiReplaceFiles({ paths, searchValue, replaceValue }) {
    ...
    const filePathChanges$ = changes$.pipe(operators_1.filter(({ srcText, outText }) => srcText !== outText), rxjs_set_operators_1.mergeSet('isSuccess', ({ srcFilePath, outFilePath }) => to_boolean_1.toBoolean(src_1.moveFile(srcFilePath, outFilePath))));
