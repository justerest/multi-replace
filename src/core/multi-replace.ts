...
export const anyCasePlaceholderPattern = Object.values(CasePlaceholder).join('|');
...
export function multiSerialize(str: string, searchValue: string) {
    return str
...
export function multiDeserialize(str: string, replaceValue: string): string {
    return str
